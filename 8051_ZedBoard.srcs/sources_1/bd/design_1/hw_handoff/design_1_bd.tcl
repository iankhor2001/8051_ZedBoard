...
proc create_root_design { parentCell } {
  ...
  set rst_led_0 [ create_bd_port -dir O rst_led_0 ]
  set txd_led_0 [ create_bd_port -dir O txd_led_0 ]

  # Create instance: oc8051_fpga_top_0, and set properties
  set block_name oc8051_fpga_top
  set block_cell_name oc8051_fpga_top_0
  if { [catch {set oc8051_fpga_top_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $oc8051_fpga_top_0 eq "" } {
  ...
  connect_bd_net -net oc8051_fpga_top_0_rst_led [get_bd_ports rst_led_0] [get_bd_pins oc8051_fpga_top_0/rst_led]
  connect_bd_net -net oc8051_fpga_top_0_txd [get_bd_pins oc8051_fpga_top_0/txd] [get_bd_pins processing_system7_0/UART1_RX]
  connect_bd_net -net oc8051_fpga_top_0_txd_led [get_bd_ports txd_led_0] [get_bd_pins oc8051_fpga_top_0/txd_led]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins oc8051_fpga_top_0/clk_100M] [get_bd_pins processing_system7_0/FCLK_CLK0]
  connect_bd_net -net processing_system7_0_UART1_TX [get_bd_pins oc8051_fpga_top_0/rxd] [get_bd_pins processing_system7_0/UART1_TX]
  connect_bd_net -net rst_0_1 [get_bd_ports rst] [get_bd_pins oc8051_fpga_top_0/rst]
